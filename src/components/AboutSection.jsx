        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
              Full-Stack Developer Intern in
              Information Technology Institute (ITI)
            </p>

            <p className="text-muted-foreground">
              I am a passionate Full-Stack Developer with a strong focus on Python, particularly using the
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
              ...
              <a
                href="https://drive.google.com/file/d/1SwyTEITtmpvxiVmR58xkZv1wttMN_RDR/view?usp=drive_link"
